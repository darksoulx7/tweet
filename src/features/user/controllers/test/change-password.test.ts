...
import { changePasswordEmailQueue } from '@service/queues/email.queue';
...
describe('ChangePassword', () => {
  ...
  describe('update', () => {
    ...
    it('should send correct json response', async () => {
      ...
      const spy = jest.spyOn(changePasswordEmailQueue, 'addEmailJob');
      ...
      expect(changePasswordEmailQueue.addEmailJob).toHaveBeenCalledWith(spy.mock.calls[0][0], spy.mock.calls[0][1]);

...
import { updateNotificationSettingsQueue } from '@service/queues/user.queue';
...
describe('Settings', () => {
  ...
  describe('update', () => {
    it('should call "addUserJob" methods', async () => {
      ...
      jest.spyOn(updateNotificationSettingsQueue, 'addUserJob');
      ...
      expect(updateNotificationSettingsQueue.addUserJob).toHaveBeenCalledWith('updateNotificationSettings', {

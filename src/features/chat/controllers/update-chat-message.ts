...
export class Update {
  ...
  public async message(req: Request, res: Response): Promise<void> {
    ...
    markMessagesAsReadQueue.addChatJob('markMessagesAsReadInDB', { senderId: new mongoose.Types.ObjectId(senderId), receiverId: new mongoose.Types.ObjectId(receiverId) });

...
export class Create {
  ...
  public async post(req: Request, res: Response): Promise<void> {
    ...
    addPostQueue.addPostJob('addPostToDB', { key: req.currentUser!.userId, value: createdPost });
  ...
  public async postWithImage(req: Request, res: Response): Promise<void> {
    ...
    await postCache.savePostToCache({ key: postObjectId, currentUserId: `${req.currentUser!.userId}`, uId: `${req.currentUser!.uId}`, createdPost });
    addPostQueue.addPostJob('addPostToDB', { key: req.currentUser!.userId, value: createdPost });
    addImageQueue.addImageJob('addImageQueue', { key: `${req.currentUser!.userId}`, imgId: result.public_id, imgVersion: result.version.toString() });

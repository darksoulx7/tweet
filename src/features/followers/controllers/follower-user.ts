...
export class Add {
  public async follower(req: Request, res: Response): Promise<void> {
    ...
    addFollowerQueue.addFollowerJob('addFollowerToDB', { keyOne: `${req.currentUser!.userId}`, keyTwo: `${followerId}`, username: req.currentUser!.username, followerDocumentId: followerObjectId });

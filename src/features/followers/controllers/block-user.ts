...
export class AddUser {
  public async block(req: Request, res: Response): Promise<void> {
    ...
    addBlockedUserQueue.addBlockedUserJob('addBlockedUserToDB', { keyOne: `${req.currentUser!.userId}`, keyTwo: `${followerId}`, type: 'block' });
  ...
  public async unblock(req: Request, res: Response): Promise<void> {
    ...
    addBlockedUserQueue.addBlockedUserJob('removeBlockedUserFromDB', { keyOne: `${req.currentUser!.userId}`, keyTwo: `${followerId}`, type: 'unblock' });
